...
CRITICAL_COLUMNS = {
    "clean_stats": ["video_id", "title", "channel_title", "views", "region"],
...
def lambda_handler(event, context):
    ...
    Expected event:
    {
        ...
        "tables": ["clean_stats", "clean_reference_data"]
    }
    """
    database = event.get("database", "yt_data_pipeline_silver")
    tables = event.get("tables", ["clean_stats"])
